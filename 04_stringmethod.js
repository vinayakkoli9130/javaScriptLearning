...
console.log(`Word is Last Or Not In String ${word.replace("I Am","You Are")}`);
console.log(`Word Are Last In String ${word.endsWith("Developer")}`);
console.log(`Word Are First On String ${word.startsWith("I")}`);
console.log(`Word Possition ${word.search("Ang")}`);
console.log(`slice Of Word Are Available Or Not In String ${word.includes("Angular")}`);
console.log(`String Is Write In UpperCase ${word.toUpperCase()}`);
