...
//it has access to the globle variable.
...
let inner = function() {
   let value3=434;
   console.log("Globel Variable",value); 
   console.log("Outer Function Variable",value2);
   console.log("Inner Function Variable",value3);
}
return inner
}
let result=out()
